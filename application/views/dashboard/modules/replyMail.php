          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" placeholder="To:" name="mailTo" value="<?php echo set_value('mailTo', isset($mail) && isset($mail->FROM_USER_ID) ? getEmailById($mail->FROM_USER_ID) : ''); ?>"/>
              </div>
              <span class="error-mess"><?php echo form_error('mailTo'); ?></span>
              <div class="form-group">
                <input class="form-control" placeholder="Subject:" name="mailSubject" value="<?php echo set_value('mailSubject', isset($mail) && isset($mail->SUBJECT) ? 'RE:' . $mail->SUBJECT : ''); ?>"/>
              </div>
