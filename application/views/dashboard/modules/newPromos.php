...
<div class="content-wrapper">
    ...
    <?php
    	...
    	echo form_open('modules/submitPromo', $form_attributes); ?> 
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="tab_1">
		    	  <div class="form-group col-md-4 col-lg-4">
						...
						<input type="text" class="form-control" id="promoTitle" name="promoTitle" value="<?php echo set_value('promoTitle') ?>" >
		        ...
		        <div class="form-group col-md-12 col-lg-12">
					...
					<div class="row">
				      <div class="hero-unit col-md-12">
				    	<textarea class="textarea wysihtml5" style="height:500px" placeholder="Enter text ..." id="promoDescription" name="promoDescription" ><?php echo set_value('promoDescription') ?></textarea>
				  	  </div>
				  	</div>
				...
				<div class="form-group col-md-6 col-lg-6">
					...
					<div class="input-group date">
						...
						<input type="text" class="form-control date datepicker" id="promoSalesPeriodFrom" name="promoSalesPeriodFrom" value="<?php echo set_value('promoSalesPeriodFrom') ?>" readonly >
					</div>
		        ...
		        <div class="form-group col-md-6 col-lg-6">
					...
					<div class="input-group date">
						...
						<input type="text" class="form-control datepicker" id="promoSalesPeriodTo" name="promoSalesPeriodTo" value="<?php echo set_value('promoSalesPeriodTo') ?>" readonly >
					</div>
				...
				<div class="form-group col-md-6 col-lg-6">
					...
					<div class="input-group date">
						...
						<input type="text" class="form-control date datepicker" id="promoValidFrom" name="promoValidFrom" value="<?php echo set_value('promoValidFrom') ?>" readonly >
					</div>
		        ...
		        <div class="form-group col-md-6 col-lg-6">
					...
					<div class="input-group date">
						...
						<input type="text" class="form-control datepicker" id="promoValidTo" name="promoValidTo" value="<?php echo set_value('promoValidTo') ?>" readonly >
					</div>
				...
				<div class="form-group col-md-3 col-lg-3">
				  ...
				  <input type="text" class="form-control numeric" id="promoPrice" name="promoPrice" value="<?php echo set_value('promoPrice') ?>">
